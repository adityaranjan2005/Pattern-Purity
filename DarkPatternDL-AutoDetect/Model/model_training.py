...
import pandas as pd
import torch
from path import CONFIG_PATH, DATASET_TSV_PATH, NN_MODEL_PICKLES_PATH
...
from dataset import DarkpatternDataset
from random_seed import set_random_seed
from text import text_to_tensor as _text_to_tensor
...
def main(cfg: DictConfig) -> None:
    ...
    try:
        dataset_path = join(hydra.utils.to_absolute_path(cfg.dataset.path), "dataset.tsv")
        cross_validation(
            n_fold=n_fold,
            pretrained=pretrained,
            batch_size=batch_size,
        ...
        print(f"Error during cross_validation: {e}")
